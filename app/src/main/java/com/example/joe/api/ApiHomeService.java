...
public interface ApiHomeService {
    ...
    @FormUrlEncoded
    @POST("")
    Observable<JsonBean<ShareContentBean>> getShareContentByServer(@Field("data") String data);
   ...
   /* ArrayMap<String, RequestBody> fileParams = new ArrayMap<>();
    ...
    Observable<JsonBean> uploadPicturesToServer(@PartMap ArrayMap<String, RequestBody> params);
    ...
    Observable<JsonBean> uploadMultipleTypeFile(@Part("data") String des, @PartMap Map<String,RequestBody> params);
