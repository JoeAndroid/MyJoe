...
public final class NetworkUtils {
    ...
    /**
     * 判断网络是否可用 <p>需添加权限 {@code <uses-permission android:name="android.permission.INTERNET"/>}</p>
     *
    ...
    /**
     * 判断wifi是否打开 <p>需添加权限 {@code <uses-permission android:name="android.permission.ACCESS_WIFI_STATE"/>}</p>
     *
     * @return {@code true}: 是<br>{@code false}: 否
     */
    ...
    /**
     * 打开或关闭wifi <p>需添加权限 {@code <uses-permission android:name="android.permission.CHANGE_WIFI_STATE"/>}</p>
     *
     * @param enabled {@code true}: 打开<br>{@code false}: 关闭
     */
    ...
    /**
     * 判断wifi数据是否可用 <p>需添加权限 {@code <uses-permission android:name="android.permission.ACCESS_WIFI_STATE"/>}</p>
     ...
     *
     * @return 网络类型 <ul> <li>{@link NetworkUtils.NetworkType#NETWORK_WIFI   } </li> <li>{@link
    ...
    /**
     * 获取IP地址 <p>需添加权限 {@code <uses-permission android:name="android.permission.INTERNET"/>}</p>
     *
    ...
    /**
     * 获取域名ip地址 <p>需添加权限 {@code <uses-permission android:name="android.permission.INTERNET"/>}</p>
     *
     * @param domain 域名
     * @return ip地址
     */
    ...
    public static synchronized int getNetWorkStatus() {
        ConnectivityManager connectManager = (ConnectivityManager) Utils.getContext()
                .getSystemService(Context.CONNECTIVITY_SERVICE);
        // 获取网络信息
